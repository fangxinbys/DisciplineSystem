<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DptMentEdit.aspx.cs" Inherits="Maticsoft.Web.Admin.DptMent.DptMentEdit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                <f:TextBox ID="txtDptName" runat="server" Label="部门名称" Required="true" ShowRedStar="true">
                                </f:TextBox>
                        ...
                        <f:FormRow runat="server">
                            <Items>
                                <f:TriggerBox ID="txtFather" TriggerIcon="Search" EnableEdit="false" Required="true"
                                    OnTriggerClick="txtFather_TriggerClick" runat="server" Label="上级部门">
                                </f:TriggerBox>
                            </Items>
                        </f:FormRow>
                            <f:FormRow>
